        ...
        <Row>
          <Col md={4} className="movieWrapper" id='Trending'>
            <Card className=" movieimage">
              <Image src={squidgameimage} alt="Squidgame" className='trendingimage'/>
          ...
          <Col md={4} className="movieWrapper">
            <Card className=" movieimage">
              <Image src={bofimage} alt="Squidgame" className='trendingimage'/>
              <div className="bg-dark">
                <div className="p-2 m-1 text-white">
                  <Card.Title>SQUIDGAME</Card.Title>
                  <Card.Text>blablabla</Card.Text>
          ...
          <Col md={4} className="movieWrapper">
            <Card className=" movieimage">
              <Image src={cloyimage} alt="Squidgame" className='trendingimage' />
              <div className="bg-dark">
                <div className="p-2 m-1 text-white">
                  <Card.Title>SQUIDGAME</Card.Title>
                  <Card.Text>blablabla</Card.Text>
          ...
          <Col md={4} className="movieWrapper">
            <Card className=" movieimage">
              <Image src={descendantsimage} alt="Squidgame" className='trendingimage'/>
              <div className="bg-dark">
                <div className="p-2 m-1 text-white">
                  <Card.Title>SQUIDGAME</Card.Title>
                  <Card.Text>blablabla</Card.Text>
          ...
          <Col md={4} className="movieWrapper">
            <Card className=" movieimage">
              <Image src={sunshineimage} alt="Squidgame" className='trendingimage' />
              <div className="bg-dark">
                <div className="p-2 m-1 text-white">
                  <Card.Title>SQUIDGAME</Card.Title>
                  <Card.Text>blablabla</Card.Text>
          ...
          <Col md={4} className="movieWrapper">
            <Card className=" movieimage">
              <Image src={tfoimage} alt="Squidgame" className='trendingimage' />
              <div className="bg-dark">
                <div className="p-2 m-1 text-white">
                  <Card.Title>SQUIDGAME</Card.Title>
                  <Card.Text>blablabla</Card.Text>
